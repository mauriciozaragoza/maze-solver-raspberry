...
void ImageProc::get_point(Mat img, Point2f &point, int color, int tolerance, int min_saturation, int min_lightness)
{
    Mat HSV;
...
bool ImageProc::get_triangle(Mat image, Vec2f &angle, Point2f &position)
{
